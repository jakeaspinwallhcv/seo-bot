...
### 3. AI Search Checks (20260106000000_add_ai_search_checks.sql)

**Status**: ⚠️ **NEEDS TO BE RUN** (Added in Days 18-21)

Creates the `ai_search_checks` table for tracking AI chatbot citations:
- Stores results from Claude, ChatGPT, Perplexity, Gemini
- Tracks whether domain was cited in response
- Includes citation context and full response text
- RLS policies for multi-tenant security

**File**: `supabase/migrations/20260106000000_add_ai_search_checks.sql`
