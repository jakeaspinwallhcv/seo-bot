        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            <div className="mb-4">
              ...
              <div className="block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 bg-gray-50 sm:text-sm">
                {projectName}
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                disabled={loading}
                autoFocus
              />
